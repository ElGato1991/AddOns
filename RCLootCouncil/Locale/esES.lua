...
L[" you are now the Master Looter and RCLootCouncil is now handling looting."] = "A partir de ahora eres el Maestro Despojador y RCLootCouncil manejará el reparto."
...
L["A new session has begun, type '/rc open' to open the voting frame."] = "Una nueva sesión ha comenzado, escriba '/rc open' para abrir ventana de votación"
...
L["accept_whispers_desc"] = "Permite a los jugadores susurrar su objeto(s) actual para que puedan tenerse en cuenta en la votación."
L["Accepted imports: 'Player Export' and 'CSV'"] = "Importaciones aceptadas: 'Exportar jugador' y 'CSV'"
L["Active"] = "Activar"
L["active_desc"] = "Desactive la opción para desactivar RCLootCouncil. Esto es útil si estás en un grupo de banda, pero no participas en el reparto de botín. Nota: Esto se restablece cada cierre de sesión."
L["Add Item"] = "Añade un objeto"
L["Add Note"] = "Añade una nota"
...
L["add_ranks_desc"] = "Seleccionar un rango mínimo para poder usar el lootcouncil:"
L["add_ranks_desc2"] = "Selecciona un rango arriba para añadir todos los miembros de ese rango y superiores al consejo. Haz clic en los rangos de la izquierda para añadir jugadores individuales al consejo. Haz clic en la pestaña «Consejo actual» para ver tu selección."
...
L["Alternatively, flag the loot as award later."] = "Alternativamente, marca el botín como recompensar más tarde."
...
L["announce_&m_desc"] = "|cfffcd400 &m|r: nota de los candidatos."
...
L["announce_awards_desc"] = "Activar los anuncios de las recompensas en el chat"
L["announce_awards_desc2"] = "Elija a qué canal(s) desea anunciar junto con el texto. Están disponibles las siguientes sustituciones de palabras clave:"
L["announce_considerations_desc"] = "Activar los anuncios de los objetos bajo consideración cada vez que se inicia una sesión."
L["announce_considerations_desc2"] = "Selecciona el canal que deseas para anunciar y el mensaje. Su mensaje sirve de cabecera para la lista de objetos."
L["announce_item_string_desc"] = "Introduzca el texto a anunciar para cada artículo. Están disponibles las siguientes sustituciones de palabras clave:"
L["Announcements"] = "Anuncios"
L["Anonymous Voting"] = "Votación Anónima"
L["anonymous_voting_desc"] = "Permite el voto anónimo, es decir, la gente no puede ver quién vota a quién."
L["Append realm names"] = "Adjuntar nombres del reino"
L["Are you sure you want to abort?"] = "¿Estás seguro de que deseas cancelar?"
L["Are you sure you want to give #item to #player?"] = "¿Estás seguro de que quieres darle %s a %s?"
...
L["auto_pass_transmog_desc"] = "Marca esta casilla para activar el autopasar de objetos que tu clase solo puede usar para transfigurar."
L["auto_pass_transmog_source_desc"] = "Marca esta casilla para habilitar el autopasar de objetos que tu clase solo puede usar para transfigurar y la apariencia ya es conocida por otro objeto."
...
L["autoloot_others_item_combat"] = "%s ha conseguido %s. Este objeto será añadido al cuadro de sesión una vez el combate termine."
...
L["Award later isn't supported when testing."] = "Recompensar más tarde no está disponible mientras está en prueba"
...
L["Click to change your note."] = "Clic para cambiar la nota"
...
L["Following items were registered in the award later list:"] = "Los siguientes objetos no están registrados en la lista de \"asignar más tarde\":"
...
L["import_desc"] = "Pega los datos aquí. Solo se mostrarán los primeros 2500 caracteres para evitar que el juego se congele"
...
L["Keep"] = "Quedármelo"
L["Latest item(s) won"] = "Último objeto(s) repartidos"
L["Length"] = "Duración"
L["Log"] = "Registro"
...
L["more_info_desc"] = "Selecciona de cuántas de tus respuestas, quieres ver los últimos objetos repartidos. Por ejemplo, seleccionando 2 (con las opciones por defecto) mostrará los últimos objetos de Especialización Principal y secundaria, junto con el tiempo desde que se adjudicaron."
...
L["Not in your guild"] = "No está en tu hermandad"
...
L["onlyUseInRaids_desc"] = "Marque esta opción para desactivar automáticamente RCLootCouncil para grupos."
L["open"] = "Abrir"
...
L["opt_closeWithEscape_desc"] = "Cuando se activa, todas las pestañas no críticas de RCLootCouncil pueden cerrarse pulsando 'Escape'. (Requiere recargar para que surta efecto en las pestañas ya creadas)."
L["opt_closeWithEscape_name"] = "Esc para Cerrar"
...
L["opt_profileSharing_fail_noProfileData"] = "No son datos de perfil. Asegúrese de que los datos importados proceden de la exportación de perfiles."
L["opt_profileSharing_import_desc"] = "Importe un nuevo perfil de RCLootCouncil. Las importaciones no borrarán el perfil, a menos que esté sobrescribiendo un perfil existente."
...
L["Player is offline"] = "Jugador está desconectado"
...
L["sync_warning1"] = "Nota: Sincronizar grandes cantidades de datos en el juego puede ser muy lento (especialmente el historial de botín)."
L["sync_warning2"] = "La configuración y el historial de botín se pueden exportar/importar como alternativa - ver '/rc profile' y/o '/rc history' respectivamente."
L["test"] = "Prueba"
L["Test"] = "Prueba"
...
L["Total awards"] = "Total objetos repartidos"
...
L["You cannot start an empty session."] = "No puedes comenzar una sesión vacía."
...
L["You haven't selected an award reason to use for disenchanting!"] = "¡No has seleccionado un motivo de recompensa para desencantar!"
